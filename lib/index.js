...
if (typeof _createHmac === 'undefined' && typeof _createHash === 'undefined') {
    console.error('FemtoS3 Module: Crypto functions are not available, please report the issue with necessary description: https://github.com/sentienhq/femtoS3.js/issues');
}
// Constants
...
class S3 {
    ...
    async listMultiPartUploads(path = '/', prefix = '', method = 'GET', opts = {}) {
        ...
        if (method === 'HEAD') {
            return {
                size: +((_a = res.headers.get(HEADER_CONTENT_LENGTH)) !== null && _a !== void 0 ? _a : '0'),
                mtime: new Date((_b = res.headers.get(HEADER_LAST_MODIFIED)) !== null && _b !== void 0 ? _b : ''),
                ETag: (_c = res.headers.get(HEADER_ETAG)) !== null && _c !== void 0 ? _c : '',
            };
        }
        const data = _parseXml(responseBody);
