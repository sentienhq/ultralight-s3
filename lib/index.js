// src/index.js
var _createHmac = crypto.createHmac || await import("node:crypto").then((m) => m.createHmac);
var _createHash = crypto.createHash || await import("node:crypto").then((m) => m.createHash);
...
var ERROR_PREFIX = "FemtoS3 Module: ";
